            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-2xl font-bold">{{ __('app.list_stores') }}</h3>
                    </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($store->logo)
                                                <img src="{{ asset($store->logo) }}" alt="{{ $store->name }}"
                                                    ...
                                                    onerror="this.onerror=null; this.src='https://via.placeholder.com/40x40?text=No+Logo';">
                                            @else
                                                <div
                                                    class="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                                                    <span class="text-gray-500 text-xs">{{ __('app.no_logo') }}</span>
                                                </div>
                                            @endif
                                        </td>
