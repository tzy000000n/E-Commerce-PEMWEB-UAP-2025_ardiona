    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h1 class="text-2xl font-bold mb-6">{{ __('app.store_verification') }}</h1>
                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">{{ __('app.owner') }}: {{ $store->user->name }}</p>
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <form action="{{ route('admin.verification.reject', $store->id) }}" method="POST"
                                        onsubmit="return confirm('{{ __('app.confirm_reject_store') }}')">
                                        @csrf
                                        <button type="submit"
                    ...
                    @empty
                        <p class="text-center text-gray-500 py-8">{{ __('app.no_unverified_stores') }}</p>
                    @endforelse
